...
# January 7 2023
# 
# Purpose: attemping to create a hash file of a previous file.
...
with open('LoremIpsum.txt', 'r') as lorem_ipsum_original:
    ...
    with open("LoremIpsumCode.txt", "w") as lorem_ipsum_code:
